...
VALUES (1, 'NEWS', '2022-08-03', 'db test title 01', 'nytipobody', 100);
INSERT INTO news(id, rubric, date, title, html_body, user_id)
VALUES (2, 'NEWS', '2022-08-04', 'db test title 02', 'nytipobody', 200);
INSERT INTO news(id, rubric, date, title, html_body, user_id)
VALUES (3, 'TESTS', '2022-08-05', 'db test title 03', 'nytipobody', 300);

INSERT INTO comments(id, date, message, news_id, user_id, level, parent_id)
VALUES (100, '2022-08-20 03:07:04.000000', 'test comment 01', 1, 100, 10, 20);
