...
public class CreateExcertionForMovieTest extends AbstractTest {
    private static String accessToken;

    @Test
    public void createExcertionForMovie() throws Exception {
        ...
        mockMvc.perform(post("/api/movies/1/excertions")
