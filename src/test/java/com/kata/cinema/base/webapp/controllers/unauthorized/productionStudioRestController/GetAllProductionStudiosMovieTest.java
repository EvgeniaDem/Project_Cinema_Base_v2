...
public class GetAllProductionStudiosMovieTest extends AbstractTest {
    ...
    public void getMovieWithAllStudios() throws Exception {
        ...
        mockMvc.perform(get("/api/movies/1/studios")
                ...
                .andExpect(jsonPath("$.[0].name").value("studio10"))
                .andExpect(jsonPath("$.[0].performance.id").value(1L))
                .andExpect(jsonPath("$.[0].performance.name").value("montage"))
                .andExpect(jsonPath("$.[1].id").value(1L))
                .andExpect(jsonPath("$.[1].name").value("studio1"))
                .andExpect(jsonPath("$.[1].performance.id").value(1L))
                .andExpect(jsonPath("$.[1].performance.name").value("montage"))
                .andExpect(jsonPath("$.[2].id").value(9L))
                .andExpect(jsonPath("$.[2].name").value("studio9"))
                .andExpect(jsonPath("$.[2].performance.id").value(2L))
                .andExpect(jsonPath("$.[2].performance.name").value("draw"))
                .andExpect(jsonPath("$.[3].id").value(2L))
                .andExpect(jsonPath("$.[3].name").value("studio2"))
                .andExpect(jsonPath("$.[3].performance.id").value(2L))
                .andExpect(jsonPath("$.[3].performance.name").value("draw"))
                .andExpect(jsonPath("$.[4].id").value(8L))
                .andExpect(jsonPath("$.[4].name").value("studio8"))
                .andExpect(jsonPath("$.[4].performance.id").value(3L))
                .andExpect(jsonPath("$.[4].performance.name").value("producing"))
                .andExpect(jsonPath("$.[5].id").value(3L))
                .andExpect(jsonPath("$.[5].name").value("studio3"))
                .andExpect(jsonPath("$.[5].performance.id").value(3L))
                .andExpect(jsonPath("$.[5].performance.name").value("producing"))
                ...
                .andExpect(jsonPath("$.[7].id").value(4L))
                .andExpect(jsonPath("$.[7].name").value("studio4"))
                .andExpect(jsonPath("$.[7].performance.id").value(4L))
                .andExpect(jsonPath("$.[7].performance.name").value("scenario"))
                .andExpect(jsonPath("$.[8].id").value(6L))
                .andExpect(jsonPath("$.[8].name").value("studio6"))
                .andExpect(jsonPath("$.[8].performance.id").value(5L))
                .andExpect(jsonPath("$.[8].performance.name").value("directing"))
                .andExpect(jsonPath("$.[9].id").value(5L))
                .andExpect(jsonPath("$.[9].name").value("studio5"))
                .andExpect(jsonPath("$.[9].performance.id").value(5L))
                .andExpect(jsonPath("$.[9].performance.name").value("directing"));
    }
    ...
    public void getRandomMovieWithStudios() throws Exception {
        ...
        mockMvc.perform(get("/api/movies/8/studios")
                ...
                .andExpect(jsonPath("$.[0].name").value("studio4"))
                .andExpect(jsonPath("$.[0].performance.id").value(1L))
                .andExpect(jsonPath("$.[0].performance.name").value("montage"))
                .andExpect(jsonPath("$.[1].id").value(22L))
                .andExpect(jsonPath("$.[1].name").value("studio2"))
                .andExpect(jsonPath("$.[1].performance.id").value(5L))
                .andExpect(jsonPath("$.[1].performance.name").value("directing"));
    }
}