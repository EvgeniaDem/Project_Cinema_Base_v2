...
public class MovieRestController {
    ...
    public MovieRestController(MovieDtoService movieDtoService,
                               ...
                               @Qualifier("forNewsController") NewsResponseDtoPaginationService newsResponseDtoPaginationService, ExcertionResponseDtoPaginationService excertionResponseDtoPaginationService, ExcertionService excertionService) {
        ...
        this.excertionResponseDtoPaginationService = excertionResponseDtoPaginationService;
    ...
    @ApiOperation(value = "Получение выдержек фильма")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Выдержки фильма успешно получены"),
    ...
    public ResponseEntity<PageDto<ExcertionResponseDto>> getExcertionResponseDto(@PathVariable Long id,
        ...
        return ResponseEntity.ok(excertionResponseDtoPaginationService
                .getPaginationExcertionResponseDtoForMovie(id, pageNumber, itemsOnPage));
    }

    @PostMapping("{id}/excertions")
    @ApiOperation(value = "Добавление выдержки фильма")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Успешное добавление выдержки фильма"),
            @ApiResponse(code = 201, message = "Успешное добавление выдержки фильма"),
            @ApiResponse(code = 401, message = "Проблема с аутентификацией или авторизацией на сайте"),
    ...
    public ResponseEntity<Void> createExcertion(@RequestBody ExcertionRequestDto excertionRequestDto,
        ...
        excertionService.createExcertionWithMovieId(excertionRequestDto, id);
